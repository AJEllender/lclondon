<a href="{{ $event->getUrl() }}" class="w-full h-auto shadow-lg flex flex-col bg-white relative">
    ...
    <div class="p-2 font-bold text-xl bg-blue-100">{{ $event->getEventName() }}</div>

    @if ($event->start_at)
        <div class="p-4 absolute top-0 right-4 bg-blue-700 text-white rounded-b-lg">
